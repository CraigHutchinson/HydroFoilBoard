...
$fa = (Render_Mode_Fast_Facets || $preview) ? Render_Mode_Facet_Angle * 4 : Render_Mode_Facet_Angle;            // 360deg/5($fa) = 60 facets (affects performance and object smoothness)
$fs = (Render_Mode_Fast_Facets || $preview) ? Render_Mode_Facet_Size * 4 : Render_Mode_Facet_Size;       // Min facet size (lower for final render)
...
Rear_Wing_sections = (Render_Mode_Fast_WingSlices || $preview) ? 10 : 25; // [8:3:100]
